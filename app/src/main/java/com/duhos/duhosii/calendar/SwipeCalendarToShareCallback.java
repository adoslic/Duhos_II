...
public class SwipeCalendarToShareCallback extends ItemTouchHelper.SimpleCallback {
    private CalendarItemAdapter calendarItemAdapter;

    public SwipeCalendarToShareCallback(CalendarItemAdapter adapter) {
    ...
    public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
        ...
        calendarItemAdapter.shareItem(position);
