...
public class NewsItemAdapter extends RecyclerView.Adapter<NewsItemAdapter.ViewHolder> {
    ...
    public NewsItemAdapter(List<News> itemList) {
        ...
        if (showShimmer) {
            ...
            holder.itemLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    NewsAbout newsAbout = new NewsAbout(itemList.get(position));
                    activity.getSupportFragmentManager().beginTransaction().replace(R.id.fragment_containter, newsAbout).addToBackStack("subFragment").commit();
                }
            });
    ...
    public void shareItem(int position) {
        ...
        String sadrzaj = itemList.get(position).getSadrzaj();
