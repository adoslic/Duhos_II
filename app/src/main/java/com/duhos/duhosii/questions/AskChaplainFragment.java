...
import com.duhos.duhosii.utils.DialogDisclaimer;
import com.duhos.duhosii.utils.GoBackFragment;
import com.duhos.duhosii.utils.JavaMailAPI;
import com.google.android.material.bottomnavigation.BottomNavigationView;
import com.google.android.material.bottomnavigation.LabelVisibilityMode;

public class AskChaplainFragment extends Fragment {
    ...
    private void sendMail() {
        ...
        javaMailAPI.execute();
        getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.fragment_containter,new GoBackFragment("pitanje")).commit();
