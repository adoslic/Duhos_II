...
public class SongsItemAdapter extends RecyclerView.Adapter<SongsItemAdapter.ViewHolder> implements Filterable {
    ...
    @NonNull
    @Override
    public SongsItemAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final SongsItemAdapter.ViewHolder holder, final int position) {
    ...
    public void shareItem(int position) {
        ...
        String tekst = itemList.get(position).getTekstPjesme();
