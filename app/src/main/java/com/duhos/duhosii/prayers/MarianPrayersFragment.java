...
public class MarianPrayersFragment extends Fragment {
    ...
    public MarianPrayersFragment(List<Prayer> itemList) {
    ...
    public void onInit() {
        ...
        adapter = new PrayerItemAdapter(itemList, getResources().getString(R.string.marijaString));
