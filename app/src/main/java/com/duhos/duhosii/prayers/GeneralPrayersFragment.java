...
public class GeneralPrayersFragment extends Fragment {
    ...
    public void onInit() {
        ...
        adapter = new PrayerItemAdapter(itemList,getContext().getResources().getString(R.string.molitvaIpozonostiString));
